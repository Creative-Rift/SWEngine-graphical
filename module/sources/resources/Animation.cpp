...
sw::Animation::Animation(const std::string &animationPath, std::string modelName)
{
    ...
    readMissingBones(animation, *sw::OpenResources::m_nmodel[modelName]);
}
...
float sw::Animation::getTicksPerSecond()
{
    return m_ticksPerSecond;
}

float sw::Animation::getDuration()
{
    return m_duration;
}
...
void sw::Animation::readHeirarchyData(sw::AssimpNodeData &dest, const aiNode *src)
{
    assert(src);
