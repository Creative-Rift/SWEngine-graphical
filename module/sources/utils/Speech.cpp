...
SW_GRAPH_MODULE_EXPORT std::vector<std::pair<std::string, std::string>> sw::Speech::m_logList;
...
SW_GRAPH_MODULE_EXPORT bool sw::Speech::dispError   = true;
SW_GRAPH_MODULE_EXPORT bool sw::Speech::dispWarning = true;
SW_GRAPH_MODULE_EXPORT bool sw::Speech::dispDebug   = true;
SW_GRAPH_MODULE_EXPORT bool sw::Speech::dispInfo    = true;
SW_GRAPH_MODULE_EXPORT bool sw::Speech::clearOnPlay = false;
SW_GRAPH_MODULE_EXPORT bool sw::Speech::dispTime = true;
SW_GRAPH_MODULE_EXPORT bool sw::Speech::stack = true;
