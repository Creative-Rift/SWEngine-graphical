...
{
    sw::Engine::activeScene().createManager<TestCptManager>("CptManager");
    auto& module = sw::Engine::activeScene().getManager<TestCptManager>("CptManager");
...
{
    sw::Engine::activeScene().createManager<TestCptManagerThrow>("ManagerThrow");
    auto& module = sw::Engine::activeScene().getManager<TestCptManagerThrow>("ManagerThrow");
...
{
    auto& manager = sw::Engine::activeScene().getManager<TestCptManager>("CptManager");
...
{
    auto& scene = sw::Engine::activeScene();
    auto& manager = scene.getManager<TestCptManager>("CptManager");
    auto& entity = scene.createEntity("oui");
...
{
    EXPECT_ANY_THROW(sw::Engine::activeScene().getManager<TestCptManager>("CptManager")["oui"]);
}

TEST_F (CptManagerTester, has_component_no_entity)
{
    EXPECT_FALSE(sw::Engine::activeScene().getManager<TestCptManager>("CptManager").hasComponent("oui"));
}
